...
public class ShipInteractionManager : MonoBehaviour
{
    ...
    public void ForceEndInteraction()
    {
        ...
        // Also end combat if in progress
        if (CombatManager.Instance != null && CombatManager.Instance.isInCombat)
        {
            // Note: You might want to implement an EndCombat method in CombatManager
            Debug.Log("Combat still in progress - player may need to retreat");
        }
    }
