...
{
    [Header("Main Location Image")]
    [SerializeField] private Image locationImage;
    [SerializeField] private RectTransform viewportFrame;

    [Header("Current Location Display (Top Right)")]
    [SerializeField] private Image currentLocationThumbnail; // Add this field
    ...
    public void UpdateLocationDisplay(LocationData location)
    {
        ...
        // Update top right thumbnail (add this section)
        if (currentLocationThumbnail != null)
        {
            currentLocationThumbnail.sprite = location.locationIcon;
            // Make sure the image is visible
            currentLocationThumbnail.enabled = true;
        }
